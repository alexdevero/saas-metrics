  ...
  <div className="page page-about">
    ...
    <div className="row justify-content-center text-center">
      <div className="col-md-8 col-lg-6">
        ...
        <ul>
          <li>
            <a href="https://www.buymeacoffee.com/alexdevero" target="_blank" className="donate-button buy-me-a-coffee-button" rel="noopener noreferrer">
